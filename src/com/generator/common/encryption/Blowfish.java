...
public class Blowfish {
	...
	static Blowfish encoder=new Blowfish("4MMl61yXu1r16n6");  //传入密钥
	 
	public static void main(String[] args) throws Exception {
		// TODO Auto-generated method stub
		String oStr="admin";  
		String encodedStr=encoder.encryptString(oStr); 
		System.out.println("---"+encodedStr);
		
		System.out.println(encoder.encryptString("3333"));
		String ss = encoder.decryptString("2c00feda5cb3cbb4f1c59c6ef48f93a4");
