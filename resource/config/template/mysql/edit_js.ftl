/*更新*/
const UPDATE = getAminUrl('admin/CENTER/${table.className?upper_case}/UPDATE');
/*保存*/
const SAVE = getAminUrl('admin/CENTER/${table.className?upper_case}/SAVE');
...
//检查是否保存还是修改操作
function checkSave() {
	var userId = $("#${table.key_fields[0].java_field_Name}").val();
	return userId;
};
