/*更新*/
const UPDATE = getAminUrl('admin/CENTER/GENERATETEMPLATES/UPDATE');
/*保存*/
const SAVE = getAminUrl('admin/CENTER/GENERATETEMPLATES/SAVE');
...
//回显Select选值
function echoSelect(){
	echoSelectData("uniteConfigId",$("#uniteConfigId").attr('value'));
}