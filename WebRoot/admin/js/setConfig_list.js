/*列表数据*/
const LIST = getAminUrl('admin/CENTER/SETCONFIG/LIST')
/*列表删除*/
const DELETE = getAminUrl('admin/CENTER/SETCONFIG/DELETE');
/*编辑*/
const EDIT = getAminUrl('admin/CENTER/SETCONFIG/EDIT');
/*批量删除*/
const BATCH_DELETE = getAminUrl('admin/CENTER/SETCONFIG/BATCH/DELETE');
/*查找单个对象*/
const GET = getAminUrl('admin/CENTER/SETCONFIG/GET');
//行对象
var rowObj = "";
	...
	table.render({
		...
		cols : [ [
			...
			},
			{
				...
				,{
					field : 'databaseConfigId' ,
					title : '数据库配置id' ,
				}
				,{
					field : 'parameterConfigIds' ,
					title : '参数配置ids' ,
				}
				,{
					field : 'templateConfigIds' ,
					title : '模板配置ids' ,
				}
				, {
					field : 'createDate' ,
...
function updateRowData(obj){
	var reqData = obj.field;
	 reqPostHasParameter(GET, {"id":reqData.id}, function(result) {
		 ...
		 rowObj.update({
				 databaseConfigId: reqData.databaseConfigId,
				 parameterConfigIds: reqData.parameterConfigIds,
				 templateConfigIds: reqData.templateConfigIds,
