/*更新*/
const UPDATE = getAminUrl('admin/CENTER/DATABASECONFIG/UPDATE');
/*保存*/
const SAVE = getAminUrl('admin/CENTER/DATABASECONFIG/SAVE');
...
//回显Select选值
function echoSelect(){
	echoSelectData("databaseType",$("#databaseType").attr('value'));
	echoSelectData("projectConfigId",$("#projectConfigId").attr('value'));
}