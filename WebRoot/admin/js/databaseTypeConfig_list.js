/*列表数据*/
const LIST = getAminUrl('admin/CENTER/DATABASETYPECONFIG/LIST')
/*列表删除*/
const DELETE = getAminUrl('admin/CENTER/DATABASETYPECONFIG/DELETE');
/*编辑*/
const EDIT = getAminUrl('admin/CENTER/DATABASETYPECONFIG/EDIT');
/*批量删除*/
const BATCH_DELETE = getAminUrl('admin/CENTER/DATABASETYPECONFIG/BATCH/DELETE');
/*查找单个对象*/
const GET = getAminUrl('admin/CENTER/DATABASETYPECONFIG/GET');
//行对象
var rowObj = "";
	...
	var reqData = obj.field;
	 reqPostHasParameter(GET, {"id":reqData.id}, function(result) {
		 ...
		 rowObj.update({
				 ...
				 updateDate: reqData.extendParam,
				 updateDate: reqData.pathParam,
			});	
	 }, function(e) {
		 console.log(e);
	 })
