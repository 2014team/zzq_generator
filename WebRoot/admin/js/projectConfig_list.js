/*列表数据*/
const LIST = getAminUrl('admin/CENTER/PROJECTCONFIG/LIST')
/*列表删除*/
const DELETE = getAminUrl('admin/CENTER/PROJECTCONFIG/DELETE');
/*编辑*/
const EDIT = getAminUrl('admin/CENTER/PROJECTCONFIG/EDIT');
/*批量删除*/
const BATCH_DELETE = getAminUrl('admin/CENTER/PROJECTCONFIG/BATCH/DELETE');
/*查找单个对象*/
const GET = getAminUrl('admin/CENTER/PROJECTCONFIG/GET');
//行对象
var rowObj = "";
