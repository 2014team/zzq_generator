/*列表数据*/
const LIST = getAminUrl('admin/CENTER/DATABASECONFIG/LIST')
/*列表删除*/
const DELETE = getAminUrl('admin/CENTER/DATABASECONFIG/DELETE');
/*编辑*/
const EDIT = getAminUrl('admin/CENTER/DATABASECONFIG/EDIT');
/*批量删除*/
const BATCH_DELETE = getAminUrl('admin/CENTER/DATABASECONFIG/BATCH/DELETE');
/*查找单个对象*/
const GET = getAminUrl('admin/CENTER/DATABASECONFIG/GET');
//行对象
var rowObj = "";
...
function updateRowData(obj){
	var reqData = obj.field;
	 reqPostHasParameter(GET, {"id":reqData.id}, function(result) {
		 ...
		 rowObj.update({
				 jdbcUrl: reqData.jdbcUrl,
				 jdbcUser: reqData.jdbcUser,
				 jdbcPassword: reqData.jdbcPassword,
				 jdbcDriver: reqData.jdbcDriver,
				 remarks: reqData.remarks,
				 databaseName: reqData.databaseName,
				 databaseTypeName: reqData.databaseTypeName,
