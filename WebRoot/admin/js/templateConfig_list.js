/*列表数据*/
const LIST = getAminUrl('admin/CENTER/TEMPLATECONFIG/LIST')
/*列表删除*/
const DELETE = getAminUrl('admin/CENTER/TEMPLATECONFIG/DELETE');
/*编辑*/
const EDIT = getAminUrl('admin/CENTER/TEMPLATECONFIG/EDIT');
/*批量删除*/
const BATCH_DELETE = getAminUrl('admin/CENTER/TEMPLATECONFIG/BATCH/DELETE');
/*查找单个对象*/
const GET = getAminUrl('admin/CENTER/TEMPLATECONFIG/GET');
//行对象
var rowObj = "";
